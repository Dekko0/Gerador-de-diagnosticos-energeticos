...
A avaliação dos quadros elétricos foi realizada  
...
\begin{figure}[H]
\centering
\includegraphics[width=0.6\textwidth]{Figuras/NR01ACFT.png}
...
resume os principais itens verificados e as principais não conformidades observadas 
...
\cellcolor{okbg} & \cellcolor{nokbg} & \cellcolor{nabg} \\ \hline
8.3.1 & Condutores sem isolação danificada ou ressecada &
\cellcolor{okbg} & \cellcolor{nokbg} & \cellcolor{nabg} \\ \hline
...
\begin{figure}[H]
\centering
\includegraphics[width=0.6\textwidth]{Figuras/sub01.png}
